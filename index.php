...
<head>
    ...
    <title>Oxygen Outsourcing - Web Oficial</title>
...
<body>
    ...
    <header id="inicio" class="main-header">
        <div class="l-container main-header__block">
            <a href="#"><img src="assets/img/oxygen-logo.jpeg" alt="Logo Oxygen outsourcing" class="main-logo"></a>
             <div class="main-menu-toggle" id="main-menu-toggle"></div>
            <nav class="main-nav" id="main-nav">               
                <ul class="main-menu">
                    <li class="main-menu__item">
                        <a href="#bienvenido" class="main-menu__link">Inicio</a>
                    </li>
                    <li class="main-menu__item">
        ...
        <div id="bienvenido" class="main-banner l-section">
            <img src="assets/img/banner-oxygen.jpg" class="main-banner__hero-img" alt="Banner quienes somos - Oxygen outsourcing">
            <div class="main-banner__content">
                <h1 class="main-banner__title wow slideInLeft" data-wow-duration=".2s" data-wow-delay=".5s">¿Estás en busca de trabajo?</h1>
                <a href="#contacto" class="button wow slideInRight" data-wow-duration=".8s" data-wow-delay=".8s">Contáctenos</a>
            </div>            
        </div>
     ...
     <div class="quienes-somos" id="quienes-somos">
            <section class="l-container quienes-somos__block">
                <article class="quienes-somos__img">
                    <img src="./assets/img/quienes-somos-oxygen.jpg" alt="Quienes somos Oxygen">
                </article>      
        ...
        <section class="contacto" id="contacto">
            <div class="l-container contacto-block">                
                    <div class="contacto-info">
                        <h3 class="contacto-title">Síguenos en nuestras redes sociales</h3>
                        <div class="contacto-info__redes">
                            <a class="redes-sociales" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="redes-sociales" href="#"><i class="fab fa-instagram"></i></a>
                            <a class="redes-sociales" href="#"><i class="far fa-envelope "></i></a>                    
                        </div>                        
                    </div>
                </article>
                <article class="contacto-info">
                    <article class="form-container">
                        ...
                        <h3 class="contacto-title">Cotiza con nosotros</h3>
                            <div class="contacto-container">
                                <input type="text" class="input-100" name="nombre" placeholder="Nombre completo" value="<?php if(!$enviado && isset($nombre)) echo $nombre ?>">
                                <input type="email" class="input-100" name="correo" placeholder="Correo" value="<?php if(!$enviado && isset($correo)) echo $correo ?>">
                                <input type="text" class="input-100" name="empresa" placeholder="Empresa" value="<?php if(!$enviado && isset($empresa)) echo $empresa ?>">
                                <input type="text" class="input-100" name="telefono" placeholder="Teléfono" value="<?php if(!$enviado && isset($telefono)) echo $telefono ?>">
                                <select name="provincia" value="<?php if(!$enviado && isset($provincia)) echo $provincia ?>">
                                    <option value="0">Escoga la provincia</option>
                                ...
                                <input type="text" class="input-100" name="direccion" placeholder="Dirección" value="<?php if(!$enviado && isset($direccion)) echo $direccion ?>">
                                ...
                                <input type="submit" name="submit" class="btn-cotizar" id="btn-cotizar">
                            </div>                                      
                        </form>  
                    </article>                     
                </article>
